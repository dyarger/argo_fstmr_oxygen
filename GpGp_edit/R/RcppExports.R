...
#' @export
vecchia_meanzero_loglik_info <- function(covparms, covfun_name, y, locs, NNarray) {
    .Call('_GpGp_vecchia_meanzero_loglik_info', PACKAGE = 'GpGp', covparms, covfun_name, y, locs, NNarray)
}
